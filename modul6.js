...
//     const newFriends = friends.filter((friend, index, array) => array.indexOf(friend) === index);
//     return newFriends;
// };
...
//   const allFriends = users.reduce((allFriends, user) => {
...
// const names = [...books].sort((firstBook, secondBook) => firstBook.rating - secondBook.rating).filter(book => book.rating > MIN_BOOK_RATING).map((book) => book.author).sort();
